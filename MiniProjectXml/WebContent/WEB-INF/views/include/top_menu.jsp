...
<!-- 상단 메뉴 부분 -->
	<nav
		...
		<!-- href="/main"으로 해야 절대경로가 된다. 그냥 main은 상대경로  -->
		
		<!-- ${root }main가 /MiniProjectJava/main으로 바뀜(페이지 소스보기에서) -->
		
		<a class="navbar-brand" href="${root }main">동원엔터프라이즈</a>
		...
		<div class="collapse navbar-collapse" id="navMenu">
			<ul class="navbar-nav">
				...
				<!-- TopMenuInterceptor.java에서 request에 topMenuList라고 넣음. 
